...
- **One of the** FB surveys (smoothed household survey).
...
foldid <- make_stratified_foldid_geo(splitted$df_train, nfold = 5)
for(ifold in 1:5){
...
```{r viz-response, eval=TRUE, fig.width=10, fig.height=30}
