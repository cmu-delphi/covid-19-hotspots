...
4. **Explain response data** (1 if 25% increase in the next 4 weeks, 0
   otherwise)
5. Training and test and validation scheme
6. Explain CV of l1 \& l2 penalized regression is not ideal
7. Explain our custom ROC curve
